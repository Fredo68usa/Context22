...
class Forecast :
    ...
    # def to_supervised(self,train, n_input, n_out=0):
    def to_supervised(self,train, n_input, n_out):
       # n_out=self.nPreds
       # flatten data
    ...
    def build_model(self,train, n_input):
        ...
        n_out = self.nPreds
        train_x, train_y = p1.to_supervised(train, n_input, n_out)
        # define parameters
